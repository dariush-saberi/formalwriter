        ...
        success: function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                if (error != 0) {
                    ...
                    $("#original").html(res[0]).show().css({
                        'font-size': '17px'
                    });
                    $("#result1").html(res[1]).show().css({
                        'font-size': '17px'
                    });
                    $("#result2").html(res[2]).show().css({
                        'font-size': '17px'
                    });
                    $("#result3").html(res[3]).show().css({
                        'font-size': '17px'
                    });
